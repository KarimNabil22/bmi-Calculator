...
class BmiBrain {
  ...
  String bmiAdvice() {
    if (_bmi > 35)
      return 'You have a way too higher than normal body weight. you shold get your life together';
    else if (_bmi > 30)
      return 'You have a way higher than normal body weight. you should lose weight';
    else if (_bmi > 25)
